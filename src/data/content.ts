...
export const projects = [
  ...
  },
  {
    ...
    images: [
      '/projects/gestion-1.png',
      '/projects/gestion-2.png',
      '/projects/gestion-3.png',
      '/projects/gestion-4.png',
    ] as string[],
    wip: true,
  ...
  },
  {
    ...
    images: [
      '/projects/defca-1.png',
      '/projects/defca-2.png',
      '/projects/defca-3.png',
    ] as string[],
    wip: true,
    device: 'browser' as 'phone' | 'browser',
  ...
  },
  {
    ...
    demo: '' as string,
    images: [
      '/projects/beast-1.jpg',
      '/projects/beast-5.png',
      '/projects/beast-2.png',
      '/projects/beast-3.png',
      '/projects/beast-4.png',
    ] as string[],
    wip: true,
    device: 'phone' as 'phone' | 'browser',
...
export const metrics = [
  { label: 'Projects Shipped', value: '04', sub: 'Real, built end-to-end' },
